                                    ...
                                    <div className="leaseCarCon  main-i invest">
                                        ...
                                        <div className="col-12 investAddCon border-2">
                                            ...
                                            <div className="col-12 text-center">
                                                <span className="flaticon-lock-1 unlock" style={{ cursor: !this.state.pending && ((enableInvest && !this.props.member.crowdsaleClosed) || buyAndActivate) ? "pointer" : "not-allowed" }} onClick={() => {
                                                    buyAndActivate ?
