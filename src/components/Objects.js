...
class Objects extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if ((nextProps.newObject && (nextProps.newObject !== this.props.newObject)) || (nextProps.newCrowdFundToken && (nextProps.newCrowdFundToken !== this.props.newCrowdFundToken))) {
        ...
        if (nextProps.members && nextProps.members !== this.state.members) {
            ...
            this.setState({ members }, () => setTimeout(() => this.setState({ progress: false }), 3500))
